...
def main():
    ...
    parser.add_argument('--step', type=int, default=10,
                        help='step size for learning rate reduction')
    ...
    for i in range(10):
        if args.gnn == 'gin':
            ...
            model = GNN(gnn_type = 'ncgnn', num_tasks = dataset.num_tasks, num_layer = args.num_layer, emb_dim = args.emb_dim, drop_ratio = args.drop_ratio, virtual_node = True).to(device)
        else:
